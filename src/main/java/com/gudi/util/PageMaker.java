...
public class PageMaker {
	...
	public String bootStrapPagingHTML(String url) {
		...
		if (curBlock > 1) {
			sBuffer.append("<li class='page-item' ><a class='page-link' href='" + url + makeQuery(1) + "'>처음</a></li>");
		}

		if (curBlock > 1) {
			sBuffer.append("<li class='page-item' ><a class='page-link' href='" + url + makeQuery(prevPage) + "'>&laquo;</a></li>");
		}
		...
		for (int i = blockBegin; i <= blockEnd; i++) {
			if (page == i) {
				...
				sBuffer.append("<a class='page-link'  href='#' onclick='return false;'>" + i + "</a></li>");
				sBuffer.append("</li>");
			} else {
		...
		if (curBlock < totBlock) {
			sBuffer.append("<li class='page-item'><a  class='page-link' href='" + url + makeQuery(nextPage) + "'>&raquo;</a></li>");
		}

		if (curBlock < totBlock) {
			sBuffer.append("<li class='page-item'><a class='page-link' href='" + url + makeQuery(totPage) + "'>마지막</a></li>");
		}
	...
	public String commentPagingHTML(String url) {
		StringBuffer sBuffer = new StringBuffer();
		sBuffer.append("<ul class='pagination'>");
		if (curBlock > 1) {
			sBuffer.append("<li class='page-item' ><a class='page-link' onclick='getCommentList(1) ;return false;'  href='#' >처음</a></li>");
		}

		if (curBlock > 1) {
			sBuffer.append("<li class='page-item' ><a class='page-link' onclick='getCommentList("+prevPage+"); return false;'  href='#' >&laquo;</a></li>");
		}
		...
		for (int i = blockBegin; i <= blockEnd; i++) {
			if (page == i) {
				...
				active = "class='page-item' ";
				sBuffer.append("<li " + active + " >");
				sBuffer.append("<a class='page-link'  onclick='getCommentList("+i+") ;return false;'  href='#'>" + i + "</a></li>");
				sBuffer.append("</li>");
			}			
		}

		if (curBlock < totBlock) {
			sBuffer.append("<li class='page-item'><a  class='page-link' onclick='getCommentList("+nextPage+") ;return false;'   href='#' >&raquo;</a></li>");
		}

		if (curBlock < totBlock) {
			sBuffer.append("<li class='page-item'><a class='page-link' onclick='getCommentList("+totPage+") ;return false;'  href='#' >마지막</a></li>");
		}
